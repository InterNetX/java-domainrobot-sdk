...
public class JsonResponseDataBackupMx {
  @JsonProperty("stid")
  ...
  @JsonProperty("data")
  private List<BackupMx> data = null;

  @JsonProperty("ctid")
  private String ctid = null;

  public JsonResponseDataBackupMx stid(String stid) {
    this.stid = stid;
    return this;
  }
  ...
  **/
  ...
  public JsonResponseDataBackupMx messages(List<Message> messages) {
    this.messages = messages;
    return this;
  }

  public JsonResponseDataBackupMx addMessagesItem(Message messagesItem) {
  ...
  **/
  ...
  public JsonResponseDataBackupMx status(ResponseStatus status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public JsonResponseDataBackupMx object(ResponseObject object) {
    this.object = object;
    return this;
  }
  ...
  **/
  ...
  public JsonResponseDataBackupMx data(List<BackupMx> data) {
    this.data = data;
    return this;
  }

  public JsonResponseDataBackupMx addDataItem(BackupMx dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<BackupMx>();
    }
  ...
  **/
  ...
  public List<BackupMx> getData() {
    return data;
  }

  public void setData(List<BackupMx> data) {
    this.data = data;
  }

  public JsonResponseDataBackupMx ctid(String ctid) {
    this.ctid = ctid;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    JsonResponseDataBackupMx jsonResponseDataBackupMx = (JsonResponseDataBackupMx) o;
    return Objects.equals(this.stid, jsonResponseDataBackupMx.stid) &&
        Objects.equals(this.messages, jsonResponseDataBackupMx.messages) &&
        Objects.equals(this.status, jsonResponseDataBackupMx.status) &&
        Objects.equals(this.object, jsonResponseDataBackupMx.object) &&
        Objects.equals(this.data, jsonResponseDataBackupMx.data) &&
        Objects.equals(this.ctid, jsonResponseDataBackupMx.ctid);
  }
  ...
  public String toString() {
    ...
    sb.append("class JsonResponseDataBackupMx {\n");
