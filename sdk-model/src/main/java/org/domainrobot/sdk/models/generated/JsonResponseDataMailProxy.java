...
public class JsonResponseDataMailProxy {
  @JsonProperty("stid")
  ...
  @JsonProperty("data")
  private List<MailProxy> data = null;

  @JsonProperty("ctid")
  private String ctid = null;

  public JsonResponseDataMailProxy stid(String stid) {
    this.stid = stid;
    return this;
  }
  ...
  **/
  ...
  public JsonResponseDataMailProxy messages(List<Message> messages) {
    this.messages = messages;
    return this;
  }

  public JsonResponseDataMailProxy addMessagesItem(Message messagesItem) {
  ...
  **/
  ...
  public JsonResponseDataMailProxy status(ResponseStatus status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public JsonResponseDataMailProxy object(ResponseObject object) {
    this.object = object;
    return this;
  }
  ...
  **/
  ...
  public JsonResponseDataMailProxy data(List<MailProxy> data) {
    this.data = data;
    return this;
  }

  public JsonResponseDataMailProxy addDataItem(MailProxy dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<MailProxy>();
    }
  ...
  **/
  ...
  public List<MailProxy> getData() {
    return data;
  }

  public void setData(List<MailProxy> data) {
    this.data = data;
  }

  public JsonResponseDataMailProxy ctid(String ctid) {
    this.ctid = ctid;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    JsonResponseDataMailProxy jsonResponseDataMailProxy = (JsonResponseDataMailProxy) o;
    return Objects.equals(this.stid, jsonResponseDataMailProxy.stid) &&
        Objects.equals(this.messages, jsonResponseDataMailProxy.messages) &&
        Objects.equals(this.status, jsonResponseDataMailProxy.status) &&
        Objects.equals(this.object, jsonResponseDataMailProxy.object) &&
        Objects.equals(this.data, jsonResponseDataMailProxy.data) &&
        Objects.equals(this.ctid, jsonResponseDataMailProxy.ctid);
  }
  ...
  public String toString() {
    ...
    sb.append("class JsonResponseDataMailProxy {\n");
