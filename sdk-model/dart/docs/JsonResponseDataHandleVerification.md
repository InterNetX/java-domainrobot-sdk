# swagger.model.JsonResponseDataHandleVerification
...
**data** | [**List&lt;HandleVerification&gt;**](HandleVerification.md) | The data for the response. The type of the objects are depending on the request and are also specified in the responseObject value of the response. | [optional] [default to []]
