...
/* The zone to create. */
  ...
  DomainRestore.fromJson(Map<String, dynamic> json) {
    if (json == null) return;
...
;
    ...
    restorePhaseEnd = json['restorePhaseEnd'] == null ? null : DateTime.parse(json['restorePhaseEnd']);
    ownerc =
...
;
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'deleted': deleted == null ? '' : deleted.toUtc().toIso8601String(),
      'restorePhaseEnd': restorePhaseEnd == null ? '' : restorePhaseEnd.toUtc().toIso8601String(),
      'ownerc': ownerc,
      'adminc': adminc,
      'techc': techc,
      'zonec': zonec,
  ...
  static List<DomainRestore> listFromJson(List<dynamic> json) {
    return json == null ? new List<DomainRestore>() : json.map((value) => new DomainRestore.fromJson(value)).toList();
  }

  static Map<String, DomainRestore> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, DomainRestore>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new DomainRestore.fromJson(value));
    }
    return map;
  }
}
